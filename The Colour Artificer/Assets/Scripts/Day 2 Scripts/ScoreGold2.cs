...
public class ScoreGold2 : MonoBehaviour {
    ...
    public void StartGoldCount()
    {
        ...
        {
            if (mix.isPink == true || mix.isPeach == true || mix.isLavender == true || mix.isAquamarine == true)
            {
                mix.enabled = false;
                req3p.SetActive(true);
                goldCounter = goldCounter + 200;
            }
            else if (mix.isCerulean == true || mix.isPurple == true)
            {
                mix.enabled = false;
        ...
        else if (requestCounter == 4)
        {
            ...
            else if (mix.isPink == true || mix.isLavender == true || mix.isMagenta == true || mix.isPurple)
            {
                mix.enabled = false;
